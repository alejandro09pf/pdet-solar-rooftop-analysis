...
def validate():
    ...
    try:
        ...
        if count != 146:
            ...
            print(f"   OK: 146 municipios en buildings_by_municipality")
        ...
        if sample:
            ...
            if 'area_util_km2' not in ms:
                ...
                print(f"   OK: Campo area_util_km2 presente: {ms['area_util_km2']} km²")

            if 'area_util_ha' not in ms:
                errors.append("Campo area_util_ha faltante en Microsoft")
            else:
                print(f"   OK: Campo area_util_ha presente: {ms['area_util_ha']} ha")
        ...
        if result:
            ...
            print(f"   OK: Total área útil: {total_util:.2f} km²")
            print(f"   OK: Total edificaciones: {total_buildings:,}")
    ...
    if not csv_munis.exists():
        ...
        if lines == 147:  # 146 + header
            print(f"   OK: municipalities_stats.csv: {lines-1} municipios")
        else:
    ...
    if not csv_regional.exists():
        ...
        if lines == 15:  # 14 + header
            print(f"   OK: regional_summary.csv: {lines-1} regiones")
        else:
    ...
    if not geojson_path.exists():
        ...
        print(f"   OK: GeoJSON existe: {size_mb:.1f} MB")
        ...
        try:
            ...
            if data.get('type') != 'FeatureCollection':
                ...
                print(f"   OK: Tipo: FeatureCollection")
            ...
            if features:
                ...
                if missing:
                    ...
                    print(f"   OK: Campos requeridos presentes")
        except Exception as e:
